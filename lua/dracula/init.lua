...
M.apply = function()
    ...
    local is_italic = vim.g.dracula_italic_comment == true
    ...
    highlight("Number", colors.orange)
    highlight("Boolean", colors.cyan)
    highlight("Float", colors.orange)
    highlight("FloatBorder", colors.white)
    highlight("Operator", colors.purple)
    highlight("Keyword", colors.cyan)
    ...
    highlight("Exception", colors.purple)
    highlight("PreProc", colors.yellow)
